...
export default function App() {
  ...
  const [searchUser, setSearchUser] = useState([]);
  const [searchText, setSearchText] = useState("");
  const [showCreateUserForm, setShowCreateUserForm] = useState(false); // New state variable for form pop-up
  ...
  const handleFormSubmit = (e) => {
    ...
    // Close the create user form pop-up after submission
  ...
  // ... (handleSearch and getUsers functions remain the same)
  ...
  return (
    <div className="App">
      ...
      {/* Button to toggle the create user form pop-up */}
